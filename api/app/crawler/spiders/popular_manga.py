...
class PopularMangaSpider(scrapy.Spider):
    ...
    start_urls = [
        "https://mangarock.com/manga/mrs-serie-132938/chapter/mrs-chapter-132939"
    ]
    ...
    def parse(self, response):
        ...
        # base_64 = self.driver.execute_script("return arguments[0].toDataURL('image/png').substring(21);", canvas[0])
        ...
        self.configure_page(action, driver)
        while True:
            ...
            try:
                ...
                base_64 = driver.execute_script("return arguments[0].toDataURL('image/png').substring(21);", canvases[idx])
            except IndexError:
                break
            ...
            next_btn = driver.find_element_by_xpath('//*[@id="page-content"]/div/div[1]/div[2]/a[2]')
